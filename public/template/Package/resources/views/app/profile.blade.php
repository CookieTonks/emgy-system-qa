                                            ...
                                            <div id="my-posts" class="tab-pane fade active show">
                                                <div class="my-post-content pt-3">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        ...
                                                        <button class="btn btn-primary mr-2"><i class="mr-2 fa fa-heart"></i>Like</button>
														<button class="btn btn-secondary" data-toggle="modal" data-target="#replyModal"><i class="fa fa-reply mr-2"></i>Reply</button>
                                                    </div>
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
