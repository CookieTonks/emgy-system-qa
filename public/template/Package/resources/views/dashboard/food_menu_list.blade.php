<div class="media mb-3 pb-3 d-md-flex d-block menu-list">
	<a href="ecom-product-detail.html"><img class="rounded mr-3 mb-md-0 mb-3" src="{{ asset('images/menus/4.png') }}" alt="" width="130"></a>
...
<div class="media mb-3 pb-3 d-md-flex d-block menu-list">
	<a href="ecom-product-detail.html"><img class="rounded mr-3 mb-md-0 mb-3" src="{{ asset('images/menus/5.png') }}" alt="" width="130"></a>
	<div class="media-body col-lg-6 pl-0">
		<div class="d-flex mb-3 align-items-center">
...
<div class="media mb-3 pb-3 d-md-flex d-block menu-list">
	<a href="ecom-product-detail.html"><img class="rounded mr-3 mb-md-0 mb-3" src="{{ asset('images/menus/6.png') }}" alt="" width="130"></a>
	<div class="media-body col-lg-6 pl-0">
		<div class="d-flex mb-3 align-items-center">
