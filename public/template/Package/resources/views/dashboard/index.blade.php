					...
					<div class="col-xl-3 col-xxl-4 col-md-6">
						<div class="card">
							...
							<div class="card-body text-center">
								...
								<a href="{!! url('/workout-statistic'); !!}" class="btn btn-outline-primary rounded">Set Target</a>
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-xxl-4 col-md-6">
										...
										<div class="featured-menus owl-carousel">
											<div class="items">
												<div class="d-sm-flex p-3 border border-light rounded">
													<a href="{!! url('/ecom-product-detail'); !!}"><img class="mr-4 food-image rounded" src="{{ asset('images/menus/3.png') }}" alt="" width="160"></a>
													<div>
														<div class="d-flex align-items-center mb-2">
															<img class="rounded-circle mr-2 profile-image" src="{{ asset('images/testimonial/3.jpg') }}" alt="" width="30">
															<span class="fs-14 text-primary">Ilham</span>
														</div>
														<h6 class="fs-16 mb-4"><a href="{!! url('/ecom-product-detail'); !!}" class="text-black">Sweet Orange Fruits with Lemon</a></h6>
														<ul>
											...
											<div class="items">
												<div class="d-sm-flex p-3 border border-light rounded">
													<a href="{!! url('/ecom-product-detail'); !!}"><img class="mr-4 food-image rounded" src="{{ asset('images/menus/1.png') }}" alt="" width="160"></a>
													<div>
														<div class="d-flex align-items-center mb-2">
															<img class="rounded-circle mr-2 profile-image" src="{{ asset('images/testimonial/1.jpg') }}" alt="" width="30">
															<span class="fs-14 text-primary">Andrew</span>
														</div>
														<h6 class="fs-16 mb-4"><a href="{!! url('/ecom-product-detail'); !!}" class="text-black">Fresh or Frozen (No Sugar Added) Fruits</a></h6>
														<ul>
															<li class="mb-2"><i class="las la-clock scale5 mr-3"></i><span class="fs-14 text-black">4-6 mins </span></li>
											...
											<div class="items">
												<div class="d-sm-flex p-3 border border-light rounded">
													<a href="{!! url('/ecom-product-detail'); !!}"><img class="mr-4 food-image rounded" src="{{ asset('images/menus/2.png') }}" alt="" width="160"></a>
													<div>
														<div class="d-flex align-items-center mb-2">
															<img class="rounded-circle mr-2 profile-image" src="{{ asset('images/testimonial/2.jpg') }}" alt="" width="30">
															<span class="fs-14 text-primary">Chintya</span>
														</div>
														<h6 class="fs-16 mb-4"><a href="{!! url('/ecom-product-detail'); !!}" class="text-black">Chicken Egg with fresh tomatos</a></h6>
														<ul>
															<li class="mb-2"><i class="las la-clock scale5 mr-3"></i><span class="fs-14 text-black">4-6 mins </span></li>
