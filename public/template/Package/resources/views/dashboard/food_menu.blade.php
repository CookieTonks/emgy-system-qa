								...
								<div class="card">
									...
									<div class="card-body loadmore-content pb-4 dz-scroll height750" id="DietMenusContent">
										<div class="media mb-3 pb-3 d-md-flex d-block menu-list">
											<a href="{!! url('/ecom-product-detail'); !!}"><img class="rounded mr-3 mb-md-0 mb-3" src="{{ asset('images/menus/4.png') }}" alt="" width="130"></a>
											<div class="media-body col-lg-6 pl-0">
												<div class="d-flex mb-3 align-items-center">
													<img src="{{ asset('images/testimonial/1.jpg') }}" alt="" width="30" class="rounded-circle mr-2">
										...
										<div class="media mb-3 pb-3 d-md-flex d-block menu-list">
											<a href="{!! url('/ecom-product-detail'); !!}"><img class="rounded mr-3 mb-md-0 mb-3" src="{{ asset('images/menus/5.png') }}" alt="" width="130"></a>
											<div class="media-body col-lg-6 pl-0">
												<div class="d-flex mb-3 align-items-center">
													<img src="{{ asset('images/testimonial/2.jpg') }}" alt="" width="30" class="rounded-circle mr-2">
													<span class="fs-14 text-black font-w500">Andrew Sceenshaver</span>
												</div>
												<h6 class="fs-16 font-w600"><a href="{!! url('/ecom-product-detail'); !!}" class="text-black">Fresh or Frozen (No Sugar Added) Fruits</a></h6>
												<p class="fs-14 mb-md-0 mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip</p>
										...
										<div class="media mb-3 pb-3 d-md-flex d-block menu-list">
											<a href="{!! url('/ecom-product-detail'); !!}"><img class="rounded mr-3 mb-md-0 mb-3" src="{{ asset('images/menus/6.png') }}" alt="" width="130"></a>
											<div class="media-body col-lg-6 pl-0">
												<div class="d-flex mb-3 align-items-center">
													<img src="{{ asset('images/testimonial/3.jpg') }}" alt="" width="30" class="rounded-circle mr-2">
													<span class="fs-14 text-black font-w500">Andrew Sceenshaver</span>
												</div>
												<h6 class="fs-16 font-w600"><a href="{!! url('/ecom-product-detail'); !!}" class="text-black">Fresh or Frozen (No Sugar Added) Fruits</a></h6>
												<p class="fs-14 mb-md-0 mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip</p>
										...
										<div class="media mb-3 pb-3 d-md-flex d-block menu-list">
											<a href="{!! url('/ecom-product-detail'); !!}"><img class="rounded mr-3 mb-md-0 mb-3" src="{{ asset('images/menus/7.png') }}" alt="" width="130"></a>
											<div class="media-body col-lg-6 pl-0">
												<div class="d-flex mb-3 align-items-center">
													<img src="{{ asset('images/testimonial/1.jpg') }}" alt="" width="30" class="rounded-circle mr-2">
													<span class="fs-14 text-black font-w500">Andrew Sceenshaver</span>
									...
									<div class="card-footer text-center border-0 pt-0 pb-4">
										<a class="text-primary dz-load-more" id="DietMenus" href="javascript:void(0);" rel="food-menu-list">View more</a>
									</div>
								</div>
							</div>
						</div>
