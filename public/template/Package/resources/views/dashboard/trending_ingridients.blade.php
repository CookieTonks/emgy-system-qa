<div class="media border-bottom py-3">
	<a href="ecom-product-detail.html"><img src="{{ asset('images/menus/11.png') }}" alt="" class="rounded mr-3" width="50"></a>
...
<div class="media border-bottom py-3">
	<a href="ecom-product-detail.html"><img src="{{ asset('images/menus/12.png') }}" alt="" class="rounded mr-3" width="50"></a>
	<div class="pr-3 mr-auto media-body">
