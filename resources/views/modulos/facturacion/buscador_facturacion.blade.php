                ...
                <div class="page-titles">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Buscador</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Facturacion</a></li>
                        </ol>
                        <a href="{{route('exportar_facturacion')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Generar reporte</a>
                    </div>
                </div>
            </div>
