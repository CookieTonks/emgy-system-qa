                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                Dashboard: Ordenes de trabajo ens gestion
                            </div>
                        </div>
    ...
    <script>
        function getHTMLString() {
            var complex_html = [
                '<br>',
                '<div class="form-inline">',
                '<select style="width:100px;" class="input-small form-control" name="Proceso[]">',
                ' <option value="TORNEADO">TORNEADO</option>',
                ' <option value="FRESADO">FRESADO</option>',
                ' <option value="RECTIFICADO">RECTIFICADO</option>',
                '<option value="CNC">CNC</option>',
                ...
                '<span class="flaticon-381-forbidden" aria-hidden="true"></span>',
                '</button>',
                '</div>',
            ].join('');
            return complex_html;
