                ...
                <div class="page-titles">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Programador</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 300px;">
                                <a target="_blank" href="{{route('order_pdf', $orden->ot)}}" class="btn btn-primary btn-sm"> <i class="flaticon-381-news"></i></a>
                                <a href="{{route('inicio_ot', $orden)}}" class="btn btn-primary btn-sm"> <i class="flaticon-381-play-button"></i></a>
                                <a href="{{route('pausa_ot', $orden)}}" class="btn btn-warning btn-sm"> <i class="flaticon-381-pause"></i></a>
                                <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#salida_produccion" data-id="{{$orden->id}}" data-ot="{{$orden->ot}}" data-cliente="{{$orden->cliente}}" data-descripcion="{{$orden->descripcion}}">
