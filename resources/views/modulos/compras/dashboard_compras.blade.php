            ...
            <div class="container-fluid">
                ...
                <div class="page-titles">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{route('exportar_compras')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Generar reporte</a>
                    </div>
                </div>
            </div>

            <div>
                <form action="{{ route('alta_oc') }}" method="post" enctype="multipart/form-data" target="_blank">
                    @csrf
                    <div class="row">
